...
import json,requests,os,git,shutil,zipfile,io

######### Function Definitions ################################################################

def check_fpc_version(min_version=320,verbose=False):
    """Check if fpc is installed and if the version is higher than min_version

    Parameters
    ----------
    min_version : int, optional
        Minimum version of fpc, by default 320

    Returns
    -------
    bool
        True if fpc is installed and the version is higher than min_version, False otherwise
    """    
    try :
        ...
        if int(fpc_version) < min_version:
        ...
        if verbose:
            print('fpc is installed and the version is higher than 3.2.0')
        return True
...
def download_simsalabim(path2prog=None,verbose=True):
    ...
    try :
        check_fpc_version(min_version=320,verbose=verbose)
...
if __name__ == '__main__':
    ...
    # check_fpc_version(verbose=True) # Check if fpc is installed and if the version is higher than min_version
    download_simsalabim(path2prog='../SIMsalabim',verbose=True) # Download SIMsalabim
